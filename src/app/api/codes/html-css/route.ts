...
// Configuración de Firebase para la conexión a la base de datos
...
// Endpoint GET para obtener código HTML/CSS por ID
...
// Endpoint POST para guardar nuevo código HTML/CSS
