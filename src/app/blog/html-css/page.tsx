...
export default function HtmlCssBlogPage() {
  ...
  const [codigo, setCodigo] = useState("// Escribe tu código HTML/CSS aquí");
  ...
  return (
    <div>
      ...
      <div className="text-center mb-10 mt-10">
        <h1 className="text-4xl font-bold mb-4 text-white">Blog de Html y Css</h1>
                      ...
                      <div className="ml-4 mt-2 space-y-2">
                        {comment.replies.map((reply) => (
                          ...
                          >
                            ...
                            <p className="text-white whitespace-pre-wrap break-words break-all w-full pl-0 pr-[3cm] bg-red-500">
                              {comment.content}
                            </p>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="El código se mostrará en el editor de Html y Css a la derecha"
                  className="w-full p-2 border rounded-lg bg-[#2a2a40] text-white"
                  rows={4}
                />
              </div>
