...
import CodeEditorJava from "@/app/components/CodeEditorJava";
  ...
  return (
    <div>
      ...
      <div className="flex gap-4 mr-20 ml-20 mb-20">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="El código se mostrará en el editor de Java a la derecha"
                  className="w-full p-2 border rounded-lg bg-[#2a2a40] text-white"
                  rows={4}
                />
              </div>
        ...
        {/* Editor/compilador Java a la derecha */}
