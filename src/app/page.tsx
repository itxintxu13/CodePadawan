  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <div className="flex justify-center mt-8">
        <div className="bg-gradient-to-tr from-blue-700 via-purple-700 to-pink-500 rounded-full p-2 shadow-2xl flex items-center justify-center border border-white/40 ring-2 ring-blue-400/40 ring-offset-2 ring-offset-gray-950"
          style={{ width: 150, height: 150, boxShadow: '0 6px 30px 0 #7c3aed55' }}>
          <img src="/logo.svg" alt="Logo CodePadawan" style={{ width: 130, height: 130, display: 'block', filter: 'drop-shadow(0 6px 20px #7c3aedcc) brightness(1.18) contrast(1.12)' }}
